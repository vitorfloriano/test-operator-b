...
import (
	...
	"github/camilamacedo86/test-operator/internal/controller"
	webhookexamplecomv1 "github/camilamacedo86/test-operator/internal/webhook/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "05388b47.my.domain",
